...
export const projectsData = [
  ...
  },
  {
    ...
    video: '/videos/ai-powered-smart-camera-dry-box.mp4',
    description:
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/azlan-ive/SafeCampus',
    featured: true,
    color: '#10b981',
  },
  {
    id: 5,
    title: 'SafeCampus Admin Dashboard',
    tagline: 'Real-Time Incident Triage, Map Geofencing & Centralized Safety Command Center',
    ...
    longDescription:
      'A modern, responsive administrative control center for university security personnel and campus administrators to monitor live crowdsourced incident reports, manage campus safety geolocations, resolve critical alerts, and oversee user permissions in real time.',
    overview:
      'The SafeCampus Admin Dashboard operates as the operational nerve center for university campus safety teams. Built with React, Vite, and Tailwind CSS, it connects directly with Firebase Authentication and Realtime Database to deliver instant live incident updates reported by students. Administrators can view incident locations on an interactive Leaflet map, update case statuses (Pending, Investigating, Resolved), audit reporter accountability, and manage verified safety locations (Security Posts, Clinics, and Emergency Call Points).',
    highlights: [
      'Real-Time Incident Triage & Resolution',
      'Interactive Leaflet Campus Map',
      'Firebase Realtime DB & Google Auth',
      'Safety Hub & Safe Zone Geolocation Management',
      'Incident Status Workflow (Pending → Investigating → Resolved)',
      'User & Responder Permission Administration',
    ],
    keyFeatures: [
      {
        title: 'Live Incident Triage & Resolution Workflow',
        desc: 'Real-time incident feed allowing administrators to review incoming crowdsourced reports, inspect attached coordinates/timestamps, and transition statuses from Pending to Resolved.',
      },
      {
        title: 'Interactive Leaflet Campus Mapping',
        desc: 'Dynamic map interface visualizing live emergency clusters, active incident coordinates, and administrator-marked safety infrastructure with custom status markers.',
      },
      {
        title: 'Firebase Authentication & Secure Access',
        desc: 'Restricted administrative portal protected by Firebase Authentication and Protected Routes to ensure only verified security personnel access sensitive safety reports.',
      },
      {
        title: 'Safety Infrastructure & Location Manager',
        desc: 'Administer campus emergency points, security checkpoints, and medical clinic pins with latitude/longitude geocoding and real-time updates broadcast to student devices.',
      },
      {
        title: 'Accountability & User Management',
        desc: 'Comprehensive student profile and reporter verification system to mitigate false alarms and maintain community trust across the campus.',
      },
    ],
    architecture:
      'Built using React 18, Vite, and Tailwind CSS for high-performance SPA rendering, with Leaflet/React-Leaflet for spatial mapping, React Router DOM for role-based protected navigation, and Firebase Realtime Database for zero-latency synchronization with the SafeCampus Mobile Android client.',
    techStack: [
      'React',
      'Vite',
      'Tailwind CSS',
    ...
    category: 'Full-Stack',
    liveUrl: 'https://github.com/azlan-ive/safecampus-admin',
    githubUrl: 'https://github.com/azlan-ive/safecampus-admin',
    featured: true,
    color: '#06b6d4',
  },
  {
    id: 6,
    title: 'Waikiki Library',
    tagline: 'Interactive Manga & Webtoon Digital Library Platform',
    role: 'Frontend Developer & UI Designer',
    year: '2024',
    image: '/images/waikiki-library.jpg',
    description:
      'Responsive digital manga & webtoon reader web platform featuring Swiper.js touch carousels, dynamic genre audio, dark/light theming, and QR code generation.',
    longDescription:
      'A modern, interactive manga and webtoon reading platform crafted with pure semantic HTML5, modern CSS3, and Vanilla JavaScript. Features touch-enabled Swiper.js carousels, animated page transitions with ScrollReveal, interactive genre exploration with audio playback, reading streaks tracking, and instant QR code generation.',
    overview:
      'Waikiki Library was developed to deliver an immersive, engaging digital reading sanctuary for manga and webtoon enthusiasts. Designed with a mobile-first philosophy, it integrates touch-enabled carousels for 13+ popular titles (including Solo Leveling, Demon Slayer, and Tower of God). The platform includes a persistent dark/light theme engine, an upcoming events hub with direct WhatsApp sharing, an interactive 5-level emoji feedback system, a dynamic reading streak dashboard, and a custom QR code generator.',
    highlights: [
      'Swiper.js 3D Touch Carousels & Sliders',
      'Dynamic Dark / Light Theme Engine',
      '13 Detailed Manga Showcase Pages',
      'Reading Streaks & Watchlist Management',
      'Events Hub with WhatsApp Sharing',
      'Built-in QR Code Generator Utility',
    ],
    keyFeatures: [
      {
        title: 'Touch-Enabled Swiper.js Carousels',
        desc: 'Fluid, responsive carousels for featured manga titles, new arrivals, promotional banners, and reader testimonials.',
      },
      {
        title: 'Instant Theme Switching (Dark & Light)',
        desc: 'Seamless CSS variable-powered theme switcher with persistent user preference storage.',
      },
      {
        title: 'Interactive Events Hub & Social Share',
        desc: 'Upcoming library cosplay summits, reading marathons, and Q&A events with 1-click WhatsApp event sharing.',
      },
      {
        title: 'Profile & Reading Progress Streaks',
        desc: 'Personalized user dashboard tracking reading streaks, achievements, continue-reading progress bars, and custom watchlists.',
      },
      {
        title: 'Emoji Satisfaction Feedback System',
        desc: 'Engaging 5-level emoji-based feedback selector and review form for community interaction.',
      },
      {
        title: 'Built-in QR Code Generator',
        desc: 'Integrated client-side QR utility allowing users to generate and download high-resolution QR codes for any link or text.',
      },
    ],
    architecture:
      'Built with semantic HTML5 and modern CSS3 (Flexbox, CSS Grid, Custom Properties, CSS Animations), enhanced with Vanilla JavaScript ES6 for DOM manipulation and state management, Swiper.js for gesture carousels, and ScrollReveal.js for dynamic entrance animations.',
    techStack: [
      'HTML5',
      'CSS3',
      'JavaScript (ES6)',
    ...
    category: 'Frontend',
    liveUrl: 'https://azlan-sys.github.io/Waikiki-Library-Frontend-Project/',
    githubUrl: 'https://github.com/azlan-sys/Waikiki-Library-Frontend-Project.git',
    featured: true,
    color: '#f59e0b',
  },
  {
